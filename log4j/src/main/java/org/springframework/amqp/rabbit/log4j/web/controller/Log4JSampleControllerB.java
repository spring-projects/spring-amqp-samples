 ...
 */
@Controller
public class Log4JSampleControllerB extends AbstractLog4JSampleController {
	...
	public MessageLoggedResponse logInfoHandlerHandler(@RequestParam("message") String message) {
		...
		return new MessageLoggedResponse("B", Level.INFO.toString(), message);
	}
	...
	public MessageLoggedResponse logDebugHandlerHandler(@RequestParam("message") String message) {
		...
		return new MessageLoggedResponse("B", Level.DEBUG.toString(), message);
	}
	...
	public MessageLoggedResponse logWarnHandler(@RequestParam("message") String message) {
		...
		return new MessageLoggedResponse("B", Level.WARN.toString(), message);
	}
	...
	public MessageLoggedResponse logErrorHandler(@RequestParam("message") String message) {
		...
		return new MessageLoggedResponse("B", Level.ERROR.toString(), message);
	}
}
